...
NextJs boilerplate comes with Stripe checkout library code so you can integrate with Stripe super fast.
...
In NextJs boilerplate, You get an exciting feature for Custom Blogs, where you just need to put your `markdown` files into `pages/doc/` dir and your blog will be up and running.
